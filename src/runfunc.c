...
/*  | run_mean_exact    | yes  | yes  | 1024     |   */
/*  | run_mean          | yes  | yes  |    2     |   */
/*  | run_mean_lite     | no   | no   |    1     |   */
/*  | run_min           | yes  | yes  |   NA     |   */
/*  | run_max           | yes  | yes  |   NA     |   */
/*  | run_quantile_lite | no   | no   |   NA     |   */
/*  | run_quantile      | yes  | yes  |   NA     |   */
/*  | run_mad_lite      | no   | no   |   NA     |   */
/*  | run_mad           | yes  | yes  |   NA     |   */
/*  | run_sd_lite       | no   | no   |    1     |   */
/*  | run_sd            | yes  | yes  |    2     |   */
/*  |-------------------+------+------+----------|   */
...
/*==================================================================================*/
void run_mean_lite(double *In, double *Out, const int *nIn, const int *nWin)
{
...
/*   Out  - results of runing moving window over array In and colecting window mean */
/*==================================================================================*/
void run_mean(double *In, double *Out, const int *nIn, const int *nWin)
...
/*   Out  - results of runing moving window over array In and colecting window mean */
/*==================================================================================*/
void run_mean_exact(double *In, double *Out, const int *nIn, const int *nWin)
...
/*==================================================================*/
void run_min(double *In, double *Out, const int *nIn, const int *nWin)
...
/*          colecting window mean                                   */
/*==================================================================*/
void run_max(double *In, double *Out, const int *nIn, const int *nWin)
{ /* full-blown version with NaN's and edge calculation */
  int i, j, k2, n=*nIn, m=*nWin;
...
/*          colecting window mean                                   */
/*==================================================================*/
void run_quantile_lite(double *In, double *Out, const int *nIn, const int *nWin, const double *Prob, const int *nProb, const int *Type)
...
void run_quantile(double *In, double *Out, const int *nIn, const int *nWin, const double *Prob, const int *nProb, const int *Type)
{ /* full-blown version with NaN's and edge calculation */
...
void run_mad_lite(double *In, double *Ctr, double *Out, const int *nIn, const int *nWin)
{
...
/*   Out  - results of runing moving window over array In and colecting window mean */
/*==================================================================================*/
void run_mad(double *In, double *Ctr, double *Out, const int *nIn, const int *nWin)
{
...
/*   Out  - results of runing moving window over array In and colecting window mean */
/*==================================================================================*/
void run_sd_lite(double *In, double *Ctr, double *Out, const int *nIn, const int *nWin)
{
...
/*   Out  - results of runing moving window over array In and colecting window mean */
/*==================================================================================*/
void run_sd(double *In, double *Ctr, double *Out, const int *nIn, const int *nWin)
{
...
int main( void ) {
  ...
  //run_max(xx, y2, &nn, &k);
  run_mean(xx, y3, &nn, &k);
  //run_mean_lite(xx, y4, &nn, &k);
  //run_mean_exact(xx, y5, &nn, &k);
  ...
  run_mad_lite (xx, yy+25, y5, &nn, &k);
  for(i=0; 2*i<k; i++) y5[i]=y5[nn-1-i]=0;
  run_mad(xx, yy+25, y6, &nn, &k);
  run_sd(xx, y3, y4, &nn, &k);
